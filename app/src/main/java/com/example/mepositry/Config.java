...
public class Config {
    ...
    /*// public static final String VIDEO_STORAGE_DIR = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES) + "/ShortVideo/";
    // .getExternalFilesDir(Environment.DIRECTORY_PICTURES)
    //public static final String VIDEO_STORAGE_DIR = Environment.getDataDirectory() + "/ShortVideo/";
    public static final String VIDEO_STORAGE_DIR =  Environment.getDownloadCacheDirectory()+ "/files/";
    //Context.getFilesDir.getAbsolutePath */

    public static final String VIDEO_STORAGE_DIR = ShortVideoApplication.getInstance().getContext().getFilesDir().getAbsolutePath() + "/";
